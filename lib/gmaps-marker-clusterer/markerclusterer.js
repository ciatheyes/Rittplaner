...
ClusterIcon.prototype.createCss = function (pos) {
    ...
    if (this.cluster_.getMarkers().length > 10 && this.cluster_.getMarkers().length < 100) { size = 27; }
    if (this.cluster_.getMarkers().length > 100 && this.cluster_.getMarkers().length < 1000) { size = 35; }
    if (this.cluster_.getMarkers().length > 1000) { size = 42; }
